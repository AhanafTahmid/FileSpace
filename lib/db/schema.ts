/**
 * Database Schema for FileSpace
 *
 * This file defines the database structure for our FileSpace application.
 ...
 * Files Table
 *
 * This table stores all files and folders in our FileSpace.
